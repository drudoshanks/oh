...
export async function up(db) {
  ...
  await db.schema
    ...
    .addForeignKeyConstraint(
      "foreign_key_patient_id",
      ["patient_id"],
      "patientInfo",
      ["patient_id"]
    )
    .addForeignKeyConstraint(
      "foreign_key_branch_id",
      ["branch_id"],
      "hospitalBranchInfo",
      ["branch_id"]
    )
  ...
  await db.schema
    ...
    .addForeignKeyConstraint(
      "foreign_key_invoice_id_invoiceTaxTransaction",
      ["invoice_id"],
      "invoiceInfo",
      ["invoice_id"]
    )
    .addForeignKeyConstraint("foreign_key_tax_id", ["tax_id"], "taxeInfo", [
      "tax_id",
    ])
    .execute();
  ...
  await db.schema
    ...
    .addForeignKeyConstraint(
      "foreign_key_invoice_id_invoiceDiscountTransaction",
      ["invoice_id"],
      "invoiceInfo",
      ["invoice_id"]
    )
    .addForeignKeyConstraint(
      "foreign_key_discount_id",
      ["discount_id"],
      "discountInfo",
      ["discount_id"]
    )
  ...
  await db.schema
    ...
    .addForeignKeyConstraint(
      "foreign_key_invoice_id_invoiceLineTransaction",
      ["invoice_id"],
      "invoiceInfo",
      ["invoice_id"]
    )
  ...
  await db.schema
    ...
    .addForeignKeyConstraint(
      "foreign_key_invoice_id_pr",
      ["invoice_id"],
      "invoiceInfo",
      ["invoice_id"]
    )
    .addForeignKeyConstraint(
      "foreign_key_patient_id_pr",
      ["patient_id"],
      "patientInfo",
      ["patient_id"]
    )
