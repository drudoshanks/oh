...
export async function up(db) {
  ...
  await db.schema
    ...
    .addColumn("country", "text")
    .addColumn("zip", "text")
    .addForeignKeyConstraint('foreign_key_parent_org_id', ['parent_org_id'], 'hospitalOrgInfo', ['org_id'])
    .execute();
